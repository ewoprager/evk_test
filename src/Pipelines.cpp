...
std::shared_ptr<PipelineMain::Instanced::type> PipelineMain::Instanced::Build(std::shared_ptr<EVK::Devices> devices, VkRenderPass renderPassHandle){
...
std::shared_ptr<PipelineMain::Once::type> PipelineMain::Once::Build(std::shared_ptr<EVK::Devices> devices, VkRenderPass renderPassHandle){
...
std::shared_ptr<PipelineHud::type> PipelineHud::Build(std::shared_ptr<EVK::Devices> devices, VkRenderPass renderPassHandle){
...
std::shared_ptr<PipelineShadow::Instanced::type> PipelineShadow::Instanced::Build(std::shared_ptr<EVK::Devices> devices, VkRenderPass renderPassHandle){
...
std::shared_ptr<PipelineShadow::Once::type> PipelineShadow::Once::Build(std::shared_ptr<EVK::Devices> devices, VkRenderPass renderPassHandle){
...
std::shared_ptr<PipelineSkyBox::type> PipelineSkyBox::Build(std::shared_ptr<EVK::Devices> devices, VkRenderPass renderPassHandle){
...
std::shared_ptr<PipelineFinal::type> PipelineFinal::Build(std::shared_ptr<EVK::Devices> devices, VkRenderPass renderPassHandle){
...
std::array<std::shared_ptr<EVK::TextureSampler>, int(Sampler::_COUNT_)> BuildSamplers(std::shared_ptr<EVK::Devices> devices){
	std::array<std::shared_ptr<EVK::TextureSampler>, int(Sampler::_COUNT_)> ret {};
	...
	ret[int(Sampler::main)] = std::make_shared<EVK::TextureSampler>(devices, samplerInfo);
	...
	ret[int(Sampler::cube)] = std::make_shared<EVK::TextureSampler>(devices, samplerInfo);
	...
	ret[(int)Sampler::shadow] = std::make_shared<EVK::TextureSampler>(devices, samplerInfo);
...
std::shared_ptr<EVK::LayeredBufferedRenderPass<SHADOW_MAP_CASCADE_COUNT>> BuildShadowMapRenderPass(std::shared_ptr<EVK::Devices> devices){
	...
	const VkAttachmentDescription lbAttachmentDescription{
		.format = DEPTH_FORMAT,
	...
	const VkSubpassDependency lbDependencies[2];
	...
	const VkRenderPassCreateInfo lbBenderPassCreateInfo = {
	...
	return std::make_shared<EVK::LayeredBufferedRenderPass<SHADOW_MAP_CASCADE_COUNT>>(devices, &lbBenderPassCreateInfo, VK_IMAGE_ASPECT_DEPTH_BIT);
}
...
std::shared_ptr<EVK::BufferedRenderPass> BuildFinalRenderPass(std::shared_ptr<EVK::Devices> devices){
	...
	// Use subpass dependencies for layout transitions
	const VkSubpassDependency bDependencies[2];
	...
	const VkRenderPassCreateInfo bRenderPassCreateInfo = {
		.sType = VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO,
		.attachmentCount = 2,
	...
	return std::make_shared<EVK::BufferedRenderPass>(devices, &bRenderPassCreateInfo);
}
